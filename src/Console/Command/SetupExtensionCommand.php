 ...
 * @internal
 */
final class SetupExtensionCommand extends AbstractSetupCommand
{
    /**
     * @var string
     */
    protected static $defaultName = 'extension';

    /**
     * @var string
     */
    protected static $defaultDescription = 'Setting up the TYPO3 rule sets for an extension';
    ...
    protected function executeSetup(InputInterface $input, OutputInterface $output): int
    {
        ...
        return $this->setup->forExtension($this->getForce($input));
    }
}
